        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <h3 className="text-lg font-medium pt-8 pb-2 ">Haredware & Electrical</h3>
              <p className="py-2">
                Are you interested in real Haredware project? I can
        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Since the beginning of my journey as a developer and other Hardware projects i have done different projects. Here are some of them 
          </p>
          <p>
